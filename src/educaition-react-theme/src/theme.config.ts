import { createTheme, em, MantineThemeOverride } from '@mantine/core';
import {
  MantineFontConfig,
  MantineRadiusConfig,
  NotificationConfig,
...
export const EDUCAITION_LIGHT_THEME: MantineThemeOverride = {
...
export const EDUCAITION_DARK_THEME: MantineThemeOverride = {
